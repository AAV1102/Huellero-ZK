...
class ZK(object):
    ...
    def set_user(self, uid=None, name='', privilege=0, password='', group_id='', user_id='', card=0):
        ...
        if self.user_packet_size == 28: #self.firmware == 6:
            ...
            command_string = pack('HB8s24s4sx7sx24s', uid, privilege, password.encode(self.encoding, errors='ignore'), name_pad, card_str, str(group_id).encode(), str(user_id).encode())
